...
[🔗**tiktok-clone-demo.vercel.app**][deploy-url]
...
<p style="display: flex; align-items: flex-start; justify-content: center;">
  <img alt="tiktok" title="#tiktok" src="./components/assets/demo.gif" > 

</p>
</div>

Welcome to the _GitHub repository_ of my **Tiktok Clone** project! Here you can find information about the project's development, such as which technologies were used, how to install and run the project, usage and more.
...
1. Clone the repo
   ```sh
   git clone https://github.com/paulofelipebrito/tiktok-clone
   ```
...
Project Link: [https://github.com/paulofelipebrito/tiktok-clone](https://github.com/paulofelipebrito/tiktok-clone)
